...
{{--    --}}{{-- For manually testing the use cases only. --}}
{{--    @php--}}
...
{{--        // modify for testing purposes only--}}
{{--        --}}
{{--        // non-recurring, trial, 1-month, 2-month, 3-month, 6-month, 1-year, lifetime, null--}}
{{--        //$membershipType = 'trial';--}}

{{--        // active, expired, cancelled, paused, lifetime, null--}}
...
{{--    --}}{{-- ----------------------------- --}}
{{--    --}}{{-- Access Levels --}}
{{--    @if(!empty($ownedNonMembershipProducts) || $hasEdgeAccess)--}}
{{--        <div class="tw-flex tw-flex-col tw-p-8 body">--}}
{{--            <h2 class="subheading">Your Access Levels</h2>--}}

{{--            <p class="tw-mt-3">Your Drumeo Account includes:</p>--}}
{{--            <ul class="tw-mt-3 tw-space-y-1">--}}
{{--                @if($hasEdgeAccess)--}}
{{--                    <li>Drumeo Membership</li>--}}
{{--                @endif--}}
...
{{--    --}}{{-- I think we should exclude this its redundant todo: consult with designer -Caleb --}}
{{--    --}}{{--        <h2 class="subheading tw-mb-3 tw-pl-8">Drumeo Membership</h2>--}}
...
{{--                <img src="{{ imgix("https://drumeo-assets.s3.amazonaws.com/logos/edge-logo_small.png", ["auto" => "format"]) }}"--}}
{{--                     alt="Drumeo logo"--}}
{{--                     class="tw-w-80">--}}
...
{{--                <p class="tw-font-bold">Drumeo gives you access to:</p>--}}
...
{{--                    Save {{ round(100 - (100 * (Prices::$drumeoEdgeAnnualFull / (Prices::$drumeoEdgeFull * 12)))) }}% with an annual plan.--}}
{{--                </p>--}}
...
{{--        @component('members.partials._modal', ['modalId' => 'modal-extend-trial-14-days'])--}}
{{--        @slot('contentSlot')--}}
...
{{--    --}}{{-- 30 Days Free  --}}
{{--    @component('members.partials._modal', ['modalId' => 'modal-free-30-days'])--}}
{{--        @slot('contentSlot')--}}
...
{{--    --}}{{-- How Can We Help?  --}}
{{--    @component('members.partials._modal', ['modalId' => 'modal-how-can-we-help'])--}}
{{--        @slot('contentSlot')--}}
...
{{--    @component('members.partials._modal', ['modalId' => 'modal-how-can-we-make-next-30-days-better'])--}}
{{--        @slot('contentSlot')--}}
...
{{--    @component('members.partials._modal', ['modalId' => 'modal-how-can-we-make-your-drumeo-edge-experience-better'])--}}
{{--        @slot('contentSlot')--}}
...
{{--    --}}{{-- Upgrade To Annual  --}}
{{--    @component('members.partials._modal', ['modalId' => 'modal-upgrade-to-annual'])--}}
{{--        @slot('contentSlot')--}}
{{--            <h1 class="heading tw-text-center">Save {{ round(100 - (100 * (Prices::$drumeoEdgeAnnualFull / (Prices::$drumeoEdgeFull * 12)))) }}% with an annual plan.</h1>--}}
...
{{--                    <p class="tw-mt-4 tw-leading-6">Save {{ round(100 - (100 * (Prices::$drumeoEdgeAnnualFull / (Prices::$drumeoEdgeFull * 12)))) }}%<br>+ get limited time--}}
{{--                        bonuses.--}}
{{--                    </p>--}}
...
{{--    @component('members.partials._modal', ['modalId' => 'modal-post-90-day-cancel-letter'])--}}
{{--        @slot('contentSlot')--}}
