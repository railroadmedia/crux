...
@php
    /**
     * @var $subscription \Railroad\Ecommerce\Entities\Subscription|null
     */
@endphp
...
@section('leftBoxTopGraySection')
    <i class="fas fa-calendar tw-text-white tw-text-3xl lg:tw-text-5xl tw-block tw-text-center tw-mt-3"></i>
    <h2 class="tw-text-white tw-text-center tw-mt-3 tw-text-xl lg:tw-text-2xl tw-mb-3">Switch To Monthly</h2>
@endsection
